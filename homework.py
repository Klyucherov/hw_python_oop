...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        cal = self.COEFF_CALORIE_1 * self.get_mean_speed() - \
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        calories_1 = self.COEFF_WALK_1 * self.weight
        calories_2 = self.get_mean_speed() ** 2 // self.height
        calories_3 = calories_2 * self.COEFF_WALK_3 * self.weight
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        calories_1 = self.get_mean_speed() + self.COEFF_SW_1
        calories = calories_1 * self.COEFF_SW_2 * self.weight
        return calories
